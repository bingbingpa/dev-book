...
### [[아이템8] finalizer 와 cleaner 사용을 피하라](#아이템8-finalizer-와-cleaner-사용을-피하라)
### [[아이템9] try-finally 보다는 try-with-resources 를 사용하라](#아이템9-try-finally-보다는-try-with-resources-를-사용하라)
